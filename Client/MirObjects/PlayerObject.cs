...
namespace Client.MirObjects
{
    public class PlayerObject : MapObject
    {
        ...
        public virtual void SetEffects()
        {
            ...
            {
                int effidx = 0;
                if (Level > 69) effidx = 220;
                Effects.Add(new SpecialEffect(Libraries.Effect, 990 + effidx, 20, 3200, this, true, true, 1) { Repeat = true });
                SpecialEffect effect = new SpecialEffect(Libraries.Effect, 1020 + effidx, 32, 4200, this, true, false, 1) { Repeat = true, Delay = delay };
            ...
            if (Level > 49 && Level < 60)
            {
                ...
                //Effects.Add(new SpecialEffect(Libraries.Effect, 1372, 20, 4000, this, true, false, 1) { Repeat = true });
            }
                            ...
                            if (Cast)
                            {
                                ...
                                switch (Spell)
                                {
                                    ...
                                    case Spell.IceStorm:
                                        ...
                                        SoundManager.PlaySound(20000 + (ushort)Spell * 10 + 1);
                                        MapControl.Effects.Add(new Effect(Libraries.Magic, 3850, 20, 2000, TargetPoint));
                                        break;
