                ...
                for (int i = MapControl.Objects.Count - 1; i >= 0; i--)
                {
                    ...
                    switch (p.Type)
                    {
                        case DamageType.Hit: //add damage level colours
                            obj.Damages.Add(new Damage(p.Damage.ToString("#,##0"), 1000, obj.Race == ObjectType.Player ? Color.Red : Color.DarkOrange, 100));
                            break;
                        case DamageType.Miss:
                            obj.Damages.Add(new Damage("Miss", 1200, obj.Race == ObjectType.Player ? Color.Yellow : Color.White, 100));
                            break;
                        case DamageType.Critical:
                            obj.Damages.Add(new Damage("Crit", 1000, obj.Race == ObjectType.Player ? Color.Red : Color.Red, 50) { Offset = 15 });
                            break;
                        case DamageType.HP:
                            obj.Damages.Add(new Damage("+" + p.Damage.ToString("#,##0"), 1000, obj.Race == ObjectType.Player ? Color.YellowGreen : Color.YellowGreen, 50));
                            break;
                        case DamageType.MP:
                            obj.Damages.Add(new Damage("+" + p.Damage.ToString("#,##0"), 1000, obj.Race == ObjectType.Player ? Color.Blue : Color.White, 50) { Offset = 15 });
                            break;
                        case DamageType.MagicalHit:
                            obj.Damages.Add(new Damage(p.Damage.ToString("#,##0"), 1000, obj.Race == ObjectType.Player ? Color.Blue : Color.White, 100));
                            break;
                        ...
                        case DamageType.Resist:
                            obj.Damages.Add(new Damage( p.Damage.ToString("#,##0"), 1000, obj.Race == ObjectType.Player ? Color.Yellow : Color.White, 100));
                            break;
                    }
                }
            }
                    ...
                    case MouseButtons.Left:
                        ...
                        if (CMain.Shift)
                        {
                            if (CMain.Time > GameScene.AttackTime && CanRideAttack()) //ArcherTest - shift click
                            {
                                ...
                                if ((User.Class == MirClass.Archer || User.Class == MirClass.HighArcher) && User.HasClassWeapon && !User.RidingMount && !User.Poison.HasFlag(PoisonType.Dazed))
                                {
                                    if (target != null)
                                    {
