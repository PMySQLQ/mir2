                ...
                case BuffType.HumUp:
                    switch (GameScene.User.Class)
                    {
                        case MirClass.HighWarrior:
                            text = string.Format("[羽化登仙(战)]\n生命值提升: + 220\n魔法值提升: + 130\n生命恢复 速度 + 10% \n魔力恢复 速度 + 10% \n背包重量增加 + 80  \n", buff.Stats[Stat.HP], buff.Stats[Stat.MP], buff.Stats[Stat.HealthRecovery], buff.Stats[Stat.SpellRecovery], buff.Stats[Stat.BagWeight]);
                            break;
                        //case MirClass.HighWizard:
                        //    text = string.Format("[羽化登仙(法)]\n生命值提升: 140증가\n魔法值提升: 210증가\n生命恢复 速度 10% 增加\n魔力恢复 速度 10% 增加\n背包重量增加 80");
                        //    break; 
                        //case MirClass.HighTaoist:
                        //    text = string.Format("[羽化登仙(道)]\n生命值提升: 170증가\n魔法值提升:  180증가\n生命恢复 速度 10% 增加\n魔力恢复 速度 10% 增加\n背包重量增加 80");
                        //    break;
                        //case MirClass.HighAssassin:
                        //    text = string.Format("[羽化登仙(刺)]\n生命值提升: 195증가\n魔法值提升: 155증가\n生命恢复 速度 10% 增加\n魔力恢复 速度 10% 增加\n背包重量增加 80");
                        //    break;
                        //case MirClass.HighArcher:
                        //    text = string.Format("[羽化登仙(弓)]\n生命值提升: 130증가\n魔法值提升: 200증가\n生命恢复 速度 10% 增加\n魔力恢复 速度 10% 增加\n背包重量增加 80");
                        //    break;
                    }
                    break;
