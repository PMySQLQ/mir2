...
{
   // [DescriptionAttribute("战士")]
    Warrior = 0,
   // [DescriptionAttribute("法师")]
    Wizard = 1,
  // [DescriptionAttribute("道士")]
    Taoist = 2,
   // [DescriptionAttribute("刺客")]
    Assassin = 3,
   // [DescriptionAttribute("弓箭手")]
    Archer = 4,
   // [DescriptionAttribute("碧血战士")]
    HighWarrior = 5,
  //  [DescriptionAttribute("虹玄法师")]
    HighWizard = 6,
   // [DescriptionAttribute("翊仙道士")]
    HighTaoist = 7,
   // [DescriptionAttribute("飞燕刺客")]
    HighAssassin = 8,
    //[DescriptionAttribute("暗鬼弓手")]
    HighArcher = 9,
}
...
[Flags]
public enum RequiredClass : ushort  //职业列表
{
    Warrior = 1 << 0,
    Wizard = 1 << 1,
    Taoist = 1 << 2,
    ...
    普通战法道 = Warrior | Wizard | Taoist,
    高级战法道 = HighWarrior | HighWizard | HighTaoist,
    非仙全职业 = 普通战法道 | Assassin | Archer,
    ...
    武士and碧血武士 = Warrior | HighWarrior,
    法师and弘玄法师 = Wizard | HighWizard,
    道士and翊仙道士 = Taoist | HighTaoist,
    刺客and飞燕刺客 = Assassin | HighAssassin,
    弓手and暗鬼弓手 = Archer | HighArcher,

    非弓升仙职业 = HighWarrior | HighWizard | HighTaoist | HighAssassin,
    非弓普通职业 = Warrior | Wizard | Taoist | Assassin,
    非弓全职业 = 非弓升仙职业 | 非弓普通职业,

    战法道全职 = 普通战法道 | 高级战法道,


    升仙全职业 = HighWarrior | HighWizard | HighTaoist | HighAssassin | HighArcher,
...
{
    None,
    ResetDuration,//重置持续时间，
    StackDuration,//堆栈持续时间，
    StackStat,//堆栈统计，
    StackStatAndDuration,//堆栈状态和持续时间，
    Infinite//永久
}
