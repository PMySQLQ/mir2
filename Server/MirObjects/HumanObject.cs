...
namespace Server.MirObjects
{
    public class HumanObject : MapObject
    {
        ...
        public override void Process()
        {
           ...
           // if (CellTime + 700 < Envir.Time) _stepCounter = 0;//起跑延迟  空气墙的问题
        ...
        protected virtual void ProcessBuffs()
        {
            ...
            if (Class > MirClass.Archer && !Humup)
            {
                var stats = new Stats();
        ...
        protected bool CanUseItem(UserItem item)
        {
            ...
            switch (Class)
            {
                ...
                case MirClass.HighArcher:
                    ...
                    {
                        ReceiveChat("HighArcher cannot use this item.", ChatType.System);
                        return false;
                    }
                    break;
            }
        ...
        public override int Attacked(HumanObject attacker, int damage, DefenceType type = DefenceType.ACAgility, bool damageWeapon = true)
        {
            ...
            switch (type)
            {
                ...
                case DefenceType.Agility:
                    BroadcastDamageIndicator(DamageType.Hit, finalDmg);
                    break;

                case DefenceType.MAC:
                case DefenceType.MACAgility:
                    BroadcastDamageIndicator(DamageType.MagicalHit, finalDmg);
                    break;
